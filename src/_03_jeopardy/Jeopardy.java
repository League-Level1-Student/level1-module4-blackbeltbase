...
return button;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(buttonPressed == firstButton) {
			askQuestion("What is a particle that has no charge called?", "neutron", 400);
		}
		else if(buttonPressed == secondButton) {
			askQuestion("What is a particle that has a positive charge called?", "proton", 500);
		}
	...
	private void askQuestion(String question, String correctAnswer, int prizeMoney) {
		...
		String userResponse = JOptionPane.showInputDialog(question);
		sound.stop();
